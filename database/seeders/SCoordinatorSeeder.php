...
class SCoordinatorSeeder extends Seeder
{
    ...
    {
        $data = [
            ['previous_name' => 'SIN COORDINADOR', 'name' => 'SIN COORDINADOR'],
            ['previous_name' => 'ALEJANDRO', 'name' => 'ALEJANDRO VAZQUEZ NIETO'],
            ['previous_name' => 'ALEJANDRO VAZQUEZ NIETO', 'name' => 'ALEJANDRO VAZQUEZ NIETO'],
            ['previous_name' => 'ALONSO LOPEZ RODOLFO', 'name' => 'ALONSO LOPEZ RODOLFO'],
            ['previous_name' => 'ANA GABRIELA RODRIGUEZ', 'name' => 'ANA GABRIELA RODRIGUEZ ROMAN'],
            ['previous_name' => 'ANA GABRIELA RODRIGUEZ ROMAN', 'name' => 'ANA GABRIELA RODRIGUEZ ROMAN'],
            ['previous_name' => 'ANA LAURA', 'name' => 'ANA LAURA'],
            ['previous_name' => 'ANTONIO', 'name' => 'ANTONIO MENDOZA ARELLANO'],
            ['previous_name' => 'BLANCA JULIETA', 'name' => 'BLANCA JULIETA'],
            ['previous_name' => 'BRENDA DINORAH RAMOS RODRIGUEZ', 'name' => 'BRENDA DINORAH RAMOS RODRIGUEZ'],
            ['previous_name' => 'BRENDA ISELA RAMIREZ RAMIREZ', 'name' => 'BRENDA ISELA RAMIREZ RAMIREZ'],
            ['previous_name' => 'CASAS CRUZ MARTHA ANGELICA', 'name' => 'MARTHA ANGELICA CASAS CRUZ'],
            ['previous_name' => 'CASTILLO RIOJAS KATHIA FERNANDA', 'name' => 'KATHIA FERNANDA CASTILLO ROJAS'],
            ['previous_name' => 'CINTHIA', 'name' => 'CINTHIA PUENTES MEDINA'],
            ['previous_name' => 'CLARA CORTES', 'name' => 'CLARA CORTES JUAREZ'],
            ['previous_name' => 'CLARA CORTES JUAREZ', 'name' => 'CLARA CORTES JUAREZ'],
            ['previous_name' => 'CORCHADO HERNANDEZ YOSHIGEN TONATIUH JOSE', 'name' => 'YOSHIGEN TONATIUH JOSE CORCHADO HERNANDEZ'],
