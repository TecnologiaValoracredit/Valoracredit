...
class PermissionPermission20022026Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $this->createPermissions(['fixed_expenses'], ['getFields'], false);

		$this->createPermissions(['requisition_globals'], ['changeStatus', 'updateStatus', 'send', 'sign'], false);
    }
