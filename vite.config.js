    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/users/user_fields.js',
                ...
                'resources/js/requisitions/tableHandler.js',
                'resources/js/requisitions/helpers.js',
                'resources/js/requisitions/productsHandler.js',
                'resources/js/requisitions/productsFormHandler.js',
                'resources/js/requisitions/addSupplier.js',
                'resources/js/requisitions/ivaUiHandler.js',
                'resources/js/requisitions/useFixedExpense.js',
