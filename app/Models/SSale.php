...
class SSale extends Model
{
    ...
    public function sPromotor()
    {
        return $this->belongsTo('App\Models\SPromotor', 's_promotor_id');
    }

    public function sCreditType()
    {
        return $this->belongsTo('App\Models\SCreditType', 's_credit_type_id');
    }
