...
class InstitutionCommissionPromotorDataTable extends DataTable
{

    public function __construct(SPromotor $promotor)
	{
     ...
     */
    public function query(InstitutionCommissionPromotor $model): QueryBuilder
    {
        return $model->select(
            "institution_commission_promotors.*",
            "institutions.id as institution_id",
            "institutions.name as institution_name",
        )
        ->where("promotor_id", $this->promotor->id)
        ->leftjoin('institutions', 'institution_commission_promotors.institution_id', '=', 'institutions.id')
        ->newQuery();
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->setTableId('institution_commission_promotors-table')
    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            ->title('Id')
            ->searchable(false)
            ->visible(false)->name("institution_commission_promotors.id"),
    ...
    {
        return 'InstitutionCommissionPromotors_' . date('YmdHis');
    }
}
