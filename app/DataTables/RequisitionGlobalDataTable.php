...
class RequisitionGlobalDataTable extends DataTable
{
    ...
    public function getActions($row){
        ...
        $exportChecks = $row->status_name == RequisitionGlobalStatusEnum::FINALIZED->value;
        ...
        // //EXPORTAR A PDF EL DOCUMENTO [PENDIENTE]
        // if ($exportChecks){
        //     $result .= '
        //         <a href="' . route('requisition_globals.exportPdf', $row->id) . '" class="btn btn-outline-success btn-icon p-auto">
