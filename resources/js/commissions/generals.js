$(document).ready(function(){
    ...
    window.addInstitution = () => {
        ...
        $.ajax({
            url: $('meta[name="app-url"]').attr('content')+`/commissions/addInstitution/${user_id}`,
            type: "POST",
            data: data,
            headers: {
            ...
            success: function(response) {
                ...
                let dt = window.LaravelDataTables['institution_commissions-table'];
                dt.draw(false)
        ...
        confirm.then((result) => {
            if (result) {
                $.ajax({
                    ...
                    success: function(response) {
                        var table = window.LaravelDataTables[`institution_commissions-table`];
                        table.draw(false);
