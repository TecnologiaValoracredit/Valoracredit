...
<x-slot:headerFiles>
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Crear Requisición Global</h5>
                <form id="form" class="row g-3 needs-validation" novalidate method="POST"  enctype="multipart/form-data" action="{{ route('requisition_globals.store')  }}" >
                    @csrf
