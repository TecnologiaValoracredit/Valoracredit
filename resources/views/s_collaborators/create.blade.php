    ...
    <div class="row layout-top-spacing">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('s_collaborators.store') }}">
                    @csrf
                    <div class="d-flex justify-content-center">
                        <div class="w-50">
                            @include("s_collaborators.fields")
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{route('s_collaborators.index')}}" class="btn btn-dark">Cancelar</a>
