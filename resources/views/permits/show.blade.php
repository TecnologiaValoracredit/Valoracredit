        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <!--Solo si es el mismo usuario, puede mandar a revisión o eliminar su permiso-->
                    @if (auth()->id() == $permit->user_id && in_array($permit->permitStatus->name, ["Creado", "Enviado", "En revisión",]))
                        <div class="row mb-2">
                            <div class="col-md-12 d-flex justify-content-center gap-4">
                                <button id="send_permit_btn" class="btn btn-primary w-15" {{ $permit->permitStatus->name != "Creado" ? "disabled" : "" }}
                    ...
                    <!--Solo ei el permiso esta aprobado, puede descargarse-->
